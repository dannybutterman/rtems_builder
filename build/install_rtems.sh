...
#sed -i 's/OPTIMIZATION_FLAGS = -O2 -g -fdata-sections -ffunction-sections/OPTIMIZATION_FLAGS = -Og -g3 -fdata-sections -ffunction-sections/g' config.ini
sed -i 's/BUILD_SAMPLES = True/BUILD_SAMPLES = False/g' config.ini
